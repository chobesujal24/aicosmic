...
import { MessageSquare, Plus, Settings, Trash2, Moon, Sun, Download, Upload, Sparkles, Wand2, Code2 } from "lucide-react";
        ...
        <SidebarGroup>
          <SidebarGroupContent>
            <div className="px-2 py-3 border-b border-sidebar-border">
              ...
              <SidebarMenuButton
                onClick={onNewChat}
                className="w-full bg-gradient-to-r from-[#527FB0] to-[#052558] text-white hover:from-[#7C9FC9] hover:to-[#527FB0] gap-2 rounded-lg shadow-lg transition-all duration-300 font-medium"
              >
            ...
            <SidebarMenu>
              <SidebarMenuItem>
                ...
                >
                  ...
                  {!collapsed && <span>Code Agent</span>}
                </SidebarMenuButton>
              </SidebarMenuItem>
            </SidebarMenu>
          </SidebarGroupContent>
            ...
            <SidebarMenu>
              <SidebarMenuItem>
                <div className="flex justify-center w-full p-2">
                  <SidebarMenuButton onClick={onToggleDarkMode} className="mx-auto flex justify-center w-full max-w-[150px]">
