...
export const ChatContainer = () => {
  ...
  return (
    <Card className="flex flex-col h-[600px] w-full max-w-4xl mx-auto shadow-2xl bg-[#0a0a0a] border-neutral-800">
      <div className="flex items-center justify-between p-4 border-b border-neutral-800 bg-neutral-900 rounded-t-lg">
        <div className="flex items-center gap-4">
          <h2 className="text-lg font-semibold text-neutral-200">AI Chat Assistant</h2>
